function createhead() {
  ...
  document.writeln("<a href='menu/home'>");
  ...
  document.writeln("<ul>");
  document.writeln("<li id='menu_home'><a href='menu/home'>主页</a></li>");
  document.writeln("<li id='menu_species_list'><a href='menu/directory'>入侵物种名录</a></li>");
  document.writeln("<li id='menu_overview_distribution'><a>分布概览<span class='downiconfont'>&#xe60b;</span></a><ul><li><a href='menu/distribution?sel=a'>数量视图</a></li><li><a href='menu/distribution?sel=b'>密度视图</a></li></ul></li>");
  document.writeln("<li id='menu_environmental_enements'><a>环境要素<span class='downiconfont'>&#xe60b;</span></a><ul><li><a href='menu/environment?sel=a'>光、温、水空间图</a></li><li><a href='menu/environment?sel=b'>高程图</a></li><li><a href='menu/environment?sel=c'>坡度图</a></li></ul></li>");
  document.writeln("<li id='menu_socioeconomic_status'><a href='menu/socialEconomy'>社会经济状况</a></li>");
  document.writeln("<li id='menu_risk_assessment'><a href='menu/assessment'>风险评估</a></li>");
  document.writeln("<li id='menu_species_list_details'>详情</li>");
  document.writeln("<li id='manager_login'><a href='/iapis/admin/home' target='_blank'>管理员入口<span class='managericonfont'>&#xe600;</span></a></li>");
  document.writeln("</ul>");
  document.writeln("</div>");
  document.writeln("</div>");
