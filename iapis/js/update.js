function updatefunc() {
  fetchData4(getUrlParam("id"), function (plantData, imgnum) {
    console.log("pnameCn");
    // $("#test").html(plantData.pnameCn);
    $("input[name=pid]").val(plantData.pid);
    ...
    //   var img = "<img src='images/P1/" + (i + 1) + ".png' height='120px'  alt='" + plantData.pnameCn + "'>";
    //   $("#images").append(img);
    // }
    $("#alter").off("click");
    $("#alter").on("click", update);
  });
}
...
function update() {
  ...
  $("#plantform input[type=text]").each(function () {
